...
### button_analyzer
- Алисе - проверить код ноды `*_with_hands.py` 175 и 177 строчки 
- Алисе - проверить код ноды `*_without_hands.py` 168 и 170 строчки 
### button_server
- Почистить код
- PEP8
- Аннотация в коде
- Описание в package.xml и setup.py
...
### completed_scripts_point-by-point_programming
- Создать
- Написать launch-файлы
- Почистить код
- PEP8
- Аннотация в коде
- Описание в package.xml и setup.py
