...
6. [🗺️ Архитектура](#️-архитектура)
   - 6.1 [`control_by_buttons_with_hands`](#control_by_buttons_with_hands)
   - 6.2 [`control_by_buttons_without_hands`](#control_by_buttons_without_hands)
7. [Лицензия](#лицензия)
...
ros2 launch completed_scripts_point-by-point_programming control_by_buttons_with_hands.launch.py

# Без манипуляторов Inspire Hands
ros2 launch completed_scripts_point-by-point_programming control_by_buttons_without_hands.launch.py
```
...
### `control_by_buttons_without_hands`
...
Этот проект является надстройкой над [unitree_h1_control_ws](https://github.com/cyberbanana777/unitree_h1_control_ws) и использует его инфраструктуру управления.

<p align="right" style="margin-top: 20px;"><a href="#-оглавление" style="text-decoration: none;">🔝 Вернуться к оглавлению</a></p>

## Предложения и корректировки

Если вы нашли ошибку или у вас есть предложения по улучшению, создайте issue в репозитории проекта или свяжитесь с авторами.
